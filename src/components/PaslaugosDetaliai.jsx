      ...
      <div className="max-w-4xl mx-auto">
        ...
        {paslauga.id === "ischeckio-remontas" && (
          <section className="mb-8 rounded-2xl border border-emerald-800/70 bg-emerald-950/90 backdrop-blur-sm p-6">
            ...
            <p className="mt-4 text-sm italic leading-relaxed text-slate-400">
              Kainos nurodytos už darbą. Galutinė kaina priklauso nuo automobilio, išmetimo sistemos būklės, priėjimo ir darbo sudėtingumo. Detalės ir medžiagos skaičiuojamos atskirai.
            </p>
          </section>
        )}
        ...
        {paslauga.id === "technine-pagalba" && (
          <section className="mb-8 rounded-2xl border border-emerald-800/70 bg-emerald-950/90 backdrop-blur-sm p-6">
            ...
            <p className="mt-4 text-sm italic leading-relaxed text-slate-400">
              Galutinė kaina priklauso nuo automobilio būklės ir darbo sudėtingumo. Detalės ir medžiagos į darbo kainą neįskaičiuotos.
            </p>
          </section>
        )}
