...
const ServicePage = () => {
  ...
  return (
    <>
      <Helmet>
        <html lang="lt" />
        <title>Autoserviso darbai: tepalų keitimas, važiuoklės remontas – AutoUP</title>
        <meta name="robots" content="noindex, nofollow" />
        <meta name="googlebot" content="noindex, nofollow" />
        <meta name="description" content="AutoUP siūlo platų autoserviso paslaugų spektrą Garliavoje, Kauno rajone. Atliekame tepalų keitimą, važiuoklės remontą ir kitas priežiūros paslaugas. Kokybė ir patikimumas garantuoti." />
        <meta name="keywords" content="autoservisas Garliava, tepalų keitimas, važiuoklės remontas, auto priežiūra, automobilių remontas Kaune, servisas Kaunas, AutoUP paslaugos, automobilių techninė priežiūra" />
        <link rel="canonical" href="https://autoup.lt/servisas" />
      </Helmet>
